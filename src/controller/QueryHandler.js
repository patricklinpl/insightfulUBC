...
var QueryHandler = (function () {
  ...
  QueryHandler.prototype.query = function (id, query) {
    ...
    for (var _i = 0, queryOutput1 = queryOutput; _i < queryOutput1.length; _i++) {
      var entry = queryOutput1[_i]
    ...
    if (typeof query.TRANSFORMATIONS !== 'undefined' && query.TRANSFORMATIONS.GROUP.length > 0) {
      ...
      queryOutput = []
      for (var _a = 0, result1 = result; _a < result1.length; _a++) {
        var entry = result1[_a]
          ...
          if (entry.length > 0) {
            ...
            if (applyCalc === 'MAX') {
              ...
              datatowork.filter(function (a) {
                ...
                if (ham1.indexOf(co) < 0) {
                  ham1.push(co)
                  return a
                }
              })
              copy[resultKey] = ham1.length
