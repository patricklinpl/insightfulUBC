...
var QueryValidator = (function () {
    ...
    QueryValidator.prototype.validateDependency = function (propName, propCallback, datasetid) {
        ...
        if (propName == 'GT' || propName == 'LT' || propName == 'EQ' || propName == 'IS') {
            ...
            for (var _i = 0, nestedKeys_1 = nestedKeys; _i < nestedKeys_1.length; _i++) {
                ...
                tracker_1 = tracker_1.concat(validateit.filter(function (item) {
                    return tracker_1.indexOf(item) < 0;
                }));
            }
            if (tracker_1.length != 0) {
                return tracker_1;
            }
        }
    ...
    QueryValidator.prototype.validateMultipleKeys = function (propName, propCallback) {
        ...
        if (propName == 'GT' || propName == 'LT' || propName == 'EQ' || propName == 'IS') {
            ...
            var tracker_2 = [];
            for (var _i = 0, nestedKeys_2 = nestedKeys; _i < nestedKeys_2.length; _i++) {
                var key = nestedKeys_2[_i];
                var newPropName = Object.keys(key).pop();
                var validateit = this.validateMultipleKeys(newPropName, key);
                tracker_2 = tracker_2.concat(validateit.filter(function (item) {
                    return tracker_2.indexOf(item) < 0;
                }));
            }
            if (tracker_2.length != 0) {
                return tracker_2;
            }
        }
        else if (propName == 'NOT') {
        ...
        switch (propName) {
            ...
            case 'OR':
                if (nestPropKey.length == 0) {
                    ...
                    var nestedKeys = propCallback[propName];
                    for (var _i = 0, nestedKeys_3 = nestedKeys; _i < nestedKeys_3.length; _i++) {
                        var key = nestedKeys_3[_i];
                        var newPropName = Object.keys(key).pop();
            ...
            case 'AND':
                if (nestPropKey.length == 0) {
                    ...
                    var nestedKeys = propCallback[propName];
                    for (var _a = 0, nestedKeys_4 = nestedKeys; _a < nestedKeys_4.length; _a++) {
                        var key = nestedKeys_4[_a];
                        var newPropName = Object.keys(key).pop();
                        var validateit = this.validateEmpty(newPropName, key);
                        if (validateit != 'Passed') {
                            return validateit;
        ...
        switch (propName) {
            ...
            case 'OR':
                if (nestPropKey.length == 0) {
                    ...
                    var nestedKeys = propCallback[propName];
                    for (var _i = 0, nestedKeys_5 = nestedKeys; _i < nestedKeys_5.length; _i++) {
                        var key = nestedKeys_5[_i];
                        var newPropName = Object.keys(key).pop();
            ...
            case 'AND':
                if (nestPropKey.length == 0) {
                    ...
                    var nestedKeys = propCallback[propName];
                    for (var _a = 0, nestedKeys_6 = nestedKeys; _a < nestedKeys_6.length; _a++) {
                        var key = nestedKeys_6[_a];
                        var newPropName = Object.keys(key).pop();
                        var validateit = this.validateFILTER(newPropName, key);
                        if (validateit != 'Passed') {
                            return validateit;
    ...
    QueryValidator.prototype.validateOPTIONS = function (query) {
        ...
        if (typeof query.OPTIONS.ORDER != 'undefined') {
            if (typeof query.OPTIONS.ORDER == 'string') {
                ...
                for (var _d = 0, validOrderKeys_1 = validOrderKeys; _d < validOrderKeys_1.length; _d++) {
                    var validKey = validOrderKeys_1[_d];
    ...
    QueryValidator.prototype.validateTransform = function (query) {
        if (typeof query.TRANSFORMATIONS == 'undefined') {
            ...
            for (var _i = 0, applyKeys_1 = applyKeys; _i < applyKeys_1.length; _i++) {
                var entry = applyKeys_1[_i];
